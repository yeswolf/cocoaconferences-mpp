...
#
# All conferences must provide a name.
#
# If the "link" is left out, then the conference name will not link to anywhere.
#
# If the "location" is left out, it will display as "TBA".
#
# If the "start" date is left out, the conference date will display as "TBA".
#
# If the "end" date is left out, it will be assumed to be the same as the start date (ie, either "TBA" or a one-day conference)
#
# If "cocoa-only" is left out, it will be assumed to be "false" (ie, it'll be listed as a "mobile development in general" conference)
#
# If both the CFP link and deadline are included, the date will be formatted as the link text. If the date has passed, it will also be struck-through.
# If only the CFP link is included, the link text will be "Deadline not specified"
# If only the CFP deadline is included, the date will be formatted. There will not be a link.
# If both the CFP deadline and link are omitted, the text will say "See website for details". There will not be a link.
#
# Special characters (like leading @ symbols) may need to be escaped. You can do so using a backslash. Eg: \@Swift
#
##########################

- name: Swift Alps 2020
  link: https://theswiftalps.com
  location: 🌐 Online
  start: 2020-11-26
  end: 2020-11-27
  cocoa-only: true

- name: NSSpain 2020 Remote Edition
  link: https://remote.nsspain.com/
  start: 2020-11-19
  end: 2020-11-20
  location: 🌐 Online
  cocoa-only: true
  cfp:
    link: https://remote.nsspain.com/index.html#c4p
    deadline: 2020-10-10

- name: Swift Heroes Digital
  link: https://swiftheroes.com/2020/
  start: 2020-10-01
  end: 2020-10-02
  location: 🌐 Online
  cocoa-only: true

- name: Back to the Mac
  link: https://backtomac.org
  start: 2020-11-09
  end: 2020-11-10
  location: 🌐 Online
  cocoa-only: true
...
- name: Pragma Conference
  ...
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSd24Hp5KRDiaLkOh7kGkjQHol88cz-7ruRt--3nqumWoOVgow/viewform?usp=sf_link
    deadline: 2020-06-30
    
- name: FrenchKit SE
  link: https://www.frenchkit.fr/
  start: 2020-10-02
  end: 2020-10-02
  location: 🇫🇷 Paris, France
  cocoa-only: true
  cfp:
    link: https://www.papercall.io/frenchkit-2020
    deadline: 2020-08-24
    
- name: Let’s Swift
  link: http://letswift.kr/2020/
  start: 2020-11-30
  end: 2020-12-04
  location: 🇰🇷 Seoul, South Korea
  cocoa-only: true

- name: Mobile Conf Thailand
  link: https://mobileconfth.com
  start: 2019-08-24
  end: 2019-08-24
...
- name: App Builders
  ...
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSegSs5vGzVmd_wM-TN8yZsi2tZ0uhhwQqNjxYBc3o8ovmEWvg/viewform
    deadline: 2020-01-26
...
- name: MobOS
  ...
  cocoa-only: false
  cfp:
    link: https://romobos.com/2020-edition/call-4-papers
    deadline: 2019-11-15
...
- name: dot Swift
  ...
  cocoa-only: true
  cfp:
    link: https://www.dotconferences.com/cfp
...
- name: Mobius
  ...
  cocoa-only: false
  cfp:
    link: https://mobiusconf.com/en/cfp/
    deadline: 2019-09-16
...
- name: NSBrazil
  ...
  cocoa-only: true
  cfp:
    link: https://www.papercall.io/nsbrazil
    deadline: 2019-09-15
...
- name: ServerSide.swift
  link: https://www.serversideswift.info/
  start: 2019-10-30
  end: 2019-11-01
  location: 🇩🇰 Copenhagen, Denmark
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSdt5YtaOo6OUk9GoDOLEH8IAvKzfnTYWccVeSV70KM44R1oXw/closedform
    deadline: 2019-07-30

- name: NSSpain
  link: https://nsspain.com/
  start: 2019-09-19
  end: 2019-09-20
  location: 🇪🇸 Logroño, Spain
  cocoa-only: true
  cfp:
    link: https://luisascorbe.typeform.com/to/V5t8cH
    deadline: 2019-06-24
...
- name: /dev/world/2019
  ...
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSfMy_CVigYeioDJ9mpoLX41TuVGbyDBmBrG-aqFAfX4ZlmENw/viewform
    deadline: 2019-06-05
...
- name: try! Swift San Jose
  link: https://www.tryswift.co/events/2019/sanjose/
  start: 2019-06-07
  end: 2019-06-07
...
- name: Pragma Conference
  ...
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSdoCMmd4XKceV6TJYaZ-0KK10RrsGbS_r1qh_14L_hOx-11kg/viewform
    deadline: 2019-07-10
    
- name: try! Swift NYC 2019
  link: https://www.tryswift.co/events/2019/nyc/
  start: 2019-09-08
  end: 2019-09-10
  location: 🇺🇸 New York City, NY, USA
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSdZGAKQLn8CmSz2dVkDzUUVTp3eV0I-7krx5VUnJQRy9FlDVQ/viewform?c=0&w=1

- name: Swift India 2019
  link: https://swiftindia.in
  start: 2019-07-28
  end: 2019-07-28
  location: 🇮🇳 Bangalore, India
  cocoa-only: true

- name: Swift India 2020
  link: https://swiftindia.in
  start: 2020-11-07
  end: 2020-11-07
  location: 🌐 Online
...
- name: Swift by Midwest
  link: https://swiftbymidwest.com
  start: 2019-04-17
  end: 2019-04-18
...
- name: MobileEra
  link: http://mobileera.rocks
  start: 2019-11-07
  end: 2019-11-08
  location: 🇳🇴 Oslo, Norway
  cocoa-only: false
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSc1jaV9hfpSz5Y-ZTvWhUMSgANaB2bSjzLG8_nYnNabbzB0mw/viewform
    deadline: 2019-05-19
...
- name: MobOS
  ...
  cocoa-only: false
  cfp:
    link: http://romobos.com/2019-edition/call-for-papers
    deadline: 2018-12-15
...
- name: iOSCon 2019
  link: https://skillsmatter.com/conferences/10823-ioscon-2019-the-conference-for-ios-and-swift-developers
  start: 2019-03-21
  end: 2019-03-22
  location: 🇬🇧 London, UK
  cocoa-only: true
...
- name: ADDC - App Design & Development Conference
  ...
  cocoa-only: false
  cfp:
    link: https://addconf.typeform.com/to/GTWQmB
    deadline: 2019-02-15
...
- name: FrenchKit
  link: https://frenchkit.fr
  start: 2019-10-07
  end: 2019-10-08
  location: 🇫🇷 Paris, France
  cocoa-only: true
  cfp:
    link: https://www.papercall.io/frenchkit-2019
    deadline: 2019-06-21
...
- name: AltConf
  ...
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSdtpfJDh53Mu6HHh539Uo51RDfd34QtXaGsvtMW8_dbUz5qSQ/viewform?usp=sf_link
    deadline: 2019-04-29

- name: AltConf London
  link: http://london.altconf.com
  start: 2019-06-03
  location: 🇬🇧 London, UK
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSduekXvS9wldtYUslGb_5ulhe7WTX4kiAL45UWXQgSfh0gSkg/viewform?usp=sf_link
    deadline: 2019-04-29

- name: AltConf Berlin
  link: http://berlin.altconf.com
  start: 2019-06-03
  location: 🇩🇪 Berlin, Germany
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLScFVjXpQnmZZsEQEX3qkKhJL48QFlGy_ZVGGusGAWJHXpwI3w/viewform?usp=sf_link
    deadline: 2019-04-29

- name: AltConf Paris
  link: http://paris.altconf.com
  start: 2019-06-03
  location: 🇫🇷 Paris, France
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLScSuuFh2o2xrgh4uNrl-NL0BNLCISM3Hw9ehmBvQgsAdBwlbA/viewform?usp=sf_link
    deadline: 2019-04-29

- name: AltConf Madrid
  link: http://madrid.altconf.com
  start: 2019-06-03
  location: 🇪🇸 Madrid, Spain
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLScCwUdS6Bi7m9X7RVnu68OtbkfRYoKs5eQ8CZ0_t9s-GG0wFA/viewform?usp=sf_link
    deadline: 2019-04-29
...
- name: SwiftFest
  ...
  cocoa-only: true
  cfp:
    link: https://docs.google.com/forms/d/e/1FAIpQLSdqZDtFNAMnoO7Bsr9Xc4dyQAmkFZOXv0YioI-AHG50uLdlUw/viewform
    deadline: 2019-05-31

- name: "BA: Swiftable"
  link: https://www.swiftable.io
...
- name: Mobiconf
  ...
  cocoa-only: false
  cfp:
    link: https://www.papercall.io/mobiconf
    deadline: 2019-05-23
...
- name: iOS Conf SG
  ...
  cocoa-only: true
  cfp:
    link: https://www.papercall.io/iosconfsg2020
    deadline: 2019-09-15

- name: iOSDevCampDC
  link: https://iosdevcampdc.com
  start: 2020-10-30
  end: 2020-10-30
  location: 🌐 Online
  cocoa-only: true
...
- name: Swift Heroes
  link: https://swiftheroes.com/2021/
  start: 2021-04-16
  end: 2021-04-16
  location: 🌐 Online
  cocoa-only: true
  cfp:
    link: https://sessionize.com/swift-heroes-digital-2021/
    deadline: 2021-01-30
...
- name: 360iDev
  ...
  location: Hybrid 🌐 Online / 🇺🇸 Denver, CO, USA
  cocoa-only: true
  cfp:
    link: https://360idev.com/call-for-papers/
    deadline: 2021-05-07
